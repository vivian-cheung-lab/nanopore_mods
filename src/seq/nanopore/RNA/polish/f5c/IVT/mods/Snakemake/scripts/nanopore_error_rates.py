...
# 
# This is using the revised clone sequence, which contains two mismatches.
...
#    ipdb.set_trace()
    ...
    counts = RDD.groupby('Clone seq')[['A','C','G','U','n']].sum()
...
def sorted_order(x):
    ...
    """
    ordering = ['none', '1:100', '1:10', '1:5', '1:2', '100%',
...
# 
# Lastly, we write these out as an Excel workbook.
# 
...
with pandas.ExcelWriter('scripts/nanopore_error_rates.xlsx') as xls:
