...
def plot_dist_comparison(events_by_base, stat_name, plot_width, output_name, mod_color='red'):
    ...
    plot_params = {
        ...
        # workaround for np.float (which statsannotation uses)
        # being deprecated
        'orient': 'v',
        'order': sorted(list(set(events_by_base['Modification']))),
